        ...
        <div className="mt-12 space-y-3">
          {faqs.map((faq, i) => (
            <FadeIn key={i} delay={i * 0.03}>
              <div className="rounded-xl border border-red-600 bg-white/[0.02] overflow-hidden">
                <button
                ...
                >
                  ...
                  <ChevronDown
                      className={cn(
                      "h-4 w-4 shrink-0 text-red-600 transition-transform duration-200",
                      openIndex === i && "rotate-180"
                    )}
                  />
                </button>
                {openIndex === i && (
                  <div className="px-6 pb-4 text-sm text-zinc-900">
                    {faq.answer}
                  </div>
                )}
              </div>
